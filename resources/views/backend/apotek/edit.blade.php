        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('apotek.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                            @method('put')
                            @csrf

                                <div class="mb-4">
                                    <label for="product_name" class="form-label">Nama Petugas</label>
                                    <input type="text" value="{{ old('nama_apotek',$data->nama_apotek) }}" placeholder="Masukkan nama petugas" class="form-control @error('nama_apotek') is-invalid @enderror" name="nama_apotek"/>
                                    @error('nama_apotek')
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="input-upload">
                                <img src="{{ $data->foto != null ? asset('img/apotek/'.$data->foto) : asset('backend/assets/imgs/theme/upload.svg') }}" alt="" id="photosPreview"/>
