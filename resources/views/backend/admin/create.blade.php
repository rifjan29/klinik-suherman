                        ...
                        <form action="{{ route('admin.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{ old('nama_admin') }}" placeholder="Masukkan nama admin" class="form-control @error('nama_admin') is-invalid @enderror" name="nama_admin"/>
                                    @error('nama_admin')
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{ old('email') }}" placeholder="Masukkan email Admin" class="form-control @error('email') is-invalid @enderror" name="email"/>
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{$message}}.
                                        </div>
