                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            @csrf
                                ...
                                <div class="mb-4">
                                    <label for="product_name" class="form-label">Nama Admin</label>
                                    <input type="text" value="{{ old('nama_admin',$data->nama_admin) }}" placeholder="Masukkan nama admin" class="form-control @error('nama_admin') is-invalid @enderror" name="nama_admin"/>
                                    @error('nama_admin')
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="input-upload">
                                <img src="{{ $data->foto != null ? asset('img/admin/'.$data->foto) : asset('backend/assets/imgs/theme/upload.svg') }}" alt="" id="photosPreview"/>
                                <input class="form-control" name="foto_admin" type="file" id="gambar_konten"/>
                            </div>
                        </div>
