    ...
    <section class="content-main">
        ...
        <div class="card mb-4">
            <header class="card-header">
                <form action="{{ route('laporan-ambulance') }}" method="GET">
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-6 p-0 ">
                        ...
                        <div class="d-flex flex-row">
                            ...
                            <div class="mx-2">
                                @if ($cetak != null)
                                    <a href="{{ route('laporan-ambulance.pdf') }}" type="button" class="btn btn-danger btn-icon-text">
                                        <i class="ti-printer btn-icon-prepend"></i>
                                        Cetak PDF
                                    </a>
                                    <a href="{{ route('laporan-ambulance.excel')."?dari=$_GET[dari]&sampai=$_GET[sampai]&xls=true" }}" type="button" class="btn btn-success btn-icon-text">
                                        <i class="ti-printer btn-icon-prepend"></i>
                                        Cetak Excel
                                    </a>
                                    <a href="{{ route('laporan-ambulance') }}" class="btn btn-outline-danger btn-icon-text">
