                        ...
                        <form action="{{ route('bank.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{ old('nama_bank') }}" placeholder="Masukkan nama bank" class="form-control @error('nama_bank') is-invalid @enderror" name="nama_bank"/>
                                    @error('nama_bank')
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" value="{{ old('no_rek') }}" placeholder="Masukkan no rekening" class="form-control @error('no_rek') is-invalid @enderror" name="no_rek"/>
                                    @error('no_rek')
                                        <div class="invalid-feedback">
                                            {{$message}}.
                                        </div>
