<figure class="text-lg-center">
    <img class="img-lg mb-3 img-avatar" src="{{ $data->foto != null ? asset('img/admin/'.$data->foto) : asset('backend/assets/imgs/people/avatar-2.png') }}" alt="User Photo">
</figure>
<div class="row">
    <div class="col-md-6">
        <div class="mb-4">
            <label for="product_name" class="form-label">Nama</label>
            <input type="text" value="{{ old('nama_petugas',$data->nama_admin) }}" readonly placeholder="Masukkan nama petugas" class="form-control" name="nama_petugas"/>
        </div>
        <div class="mb-4">
...
<div class="d-flex justify-content-end">
    <a href="{{ route('admin.edit',$data->id) }}" class="btn btn-primary"> <i class="material-icons md-edit"></i>  Edit Profil</a>
