...
<section id="about" class="about">
    <div class="container aos-init aos-animate" data-aos="fade-up">
        ...
        <div class="row content mt-4">
            <div class="col-lg-12">
                <p class="mb-4">
                    Rawat jalan merupakan pelayanan medis kepada seorang pasien untuk tujuan diagnosis, pengobatan, rehabilitasi, dan pelayanan kesehatan lainnya, tanpa mengharuskan pasien tersebut di rawat inap. Seorang pasien yang menjalani rawat jalan tidak perlu mengeluarkan biaya untuk menginap. 
                    Rawat Jalan pada Klinik dr Suherman terdiri dari beberapa pelayanan poli :
                </p>
                <div class="accordion" id="accordionPanelsStayOpenExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                                <span style="font-size: 18px; font-weight: bold; color:#37517e">Poli Umum</span>
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                <span style="font-size: 18px; font-weight: bold; color:#37517e">Poli KIA</span>
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                <span style="font-size: 18px; font-weight: bold; color:#37517e">Poli Gigi</span>
                            </button>
                        </h2>
